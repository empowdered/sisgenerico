...
{	
echo " Bienvenido: ".base64_decode($_SESSION["nbusuario"])." al sistema para la gestión de iInfraestructura de laboratorios"; 
}
?>
    </div>
</div>
				...
				<div class="dropdownContain">
					...
					<div class="triangle"></div>
						<ul>
                            ...
                            <?php if($control_inventario !="" && $permiso_inventario=="administrador"){?>
...
<div id="info_consolidar" style=" z-index:2; height:10px; width:10px; position:absolute; left:20px; top:10px; visibility:hidden; font-size:10px; text-align:left;">
 ...
 <?php if($control_inventario == "ok" or $control_total == "ok"){ ?>  
            <div class="row center-block" id="contenedor_menu_central">
             <div class="page-header">MODULO DE INVENTARIO</div> 
...
?>
                    ...
                    <?php if($permiso_inventario =="administrador" or $permiso_inventario=="visualizador" or $permiso_inventario == "controltotal"){?> 
                    <div class="text-center" align="center" onclick="javascript:abrir('item_menu6');" style="font-size:12px;">
                    	Reportes
                    </div>
                   <?php } ?><!-- aca va la llave -->
                    </div>
...
{	
	 ...
	 switch(id){
				...
				case 'item_menu3': locacion = "modulos/publicador/index.php";
									break;
                case 'cambio_clave': locacion = "cambiarClaves.php";alto=300;ancho=400;
                                    break;
