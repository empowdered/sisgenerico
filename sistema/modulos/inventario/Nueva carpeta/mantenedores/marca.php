...
if($cargar=="cargarDatos")
{
	...
	$recurso = mysqli_query($link,$select);
	if($recurso!=NULL)
	{
...
if($cargar=="borrarDatos")
{
	...
	$recurso = mysqli_query($link,$delete);
	if($recurso!=NULL)
	{
...
if($marca!="" && $observacion!=""  && $opcion!="")
{
		if($opcion=="Crear")
		{
			...
			$recurso = mysqli_query($link,$crearMarca);
			if($recurso!=NULL)
			{
				$fila = mysqli_fetch_row($recurso);
		...
		if($opcion=="Actualizar")
		{
			...
			$recurso = mysqli_query($link,$actualizaMarca);
			if($recurso!=NULL)
			{
				$fila = mysqli_fetch_row($recurso);
...
<?=rtrim($observacion)?>
        ...
        <tr>
        <td>
        <input type="button" name="opcion" value="Actualizar" class="boton" onclick="javascript:window.location='marca.php';"/>
        </td>
        </tr>
        </table>
        </form>
